'''
    NOTE: this script is *isolated* from other scripts, which means
...
if __name__ == '__main__':
    gradio_config = yaml.safe_load(open('inference/gradio/gradio_settings.yaml', encoding='utf-8'))
    g = GradioInfer(**gradio_config)
    g.run()


# python inference/gradio/infer.py --config configs/midi/cascade/opencs/ds60_rel.yaml --exp_name 0303_opencpop_ds58_midi
# python inference/ds_cascade.py --config configs/midi/cascade/opencs/ds60_rel.yaml --exp_name 0303_opencpop_ds58_midi
# CUDA_VISIBLE_DEVICES=3 python inference/gradio/infer.py --config configs/midi/e2e/opencpop/ds100_adj_rel.yaml --exp_name 0228_opencpop_ds100_rel